...
const cases = [
  ...
  },
  {
    ...
    metric: "4 months",
    metricLabel: "data foundation, analytics & AI",
    blurb: "A real estate investor replaced manual exports and a breaking dashboard with accurate automated data, always on analytics, and LLM analysts for financial reporting, leasing, vacancy, performance vs pro forma, and distributions. Weeks of manual work now done in hours.",
    chips: ["4 months", "weeks → hours", "<$20/mo infra"],
  },
  {
