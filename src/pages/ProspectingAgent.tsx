...
const ProspectingAgent = () => (
  <CaseStudyLayout
    ...
    icon={iconPipeline}
    stats={[
      ["4–6 hrs", "Weekly research & outreach before"],
  ...
  >
    <h2>What it is</h2>
    <p>
      Each Prospecting Agent is custom-built for one client. The client fills a structured intake form, and
      we generate a complete prospecting system tuned to their ICP, voice, message strategy, and
      disqualifiers - then hand it back as a working tool they run themselves.
    </p>

    <h2>How it works</h2>
    <ul>
      <li><strong>Client intake</strong> - A 4-section intake form covering ICP, offer, voice, and context.</li>
    ...
    <h3>The challenge</h3>
    <p>
      A creative agency was spending <strong>4–6 hours every week</strong> on account research and cold
      outreach - manually digging through company sites, hunting down the right person on LinkedIn, and
      drafting one-off messages. The work was real but mechanical, and it crowded out the part of the job
      that actually moved deals forward: engaging with the accounts and people already showing interest.
    </p>
    ...
    <h3>The outcome</h3>
    <p>
      That 4–6 hour weekly grind now takes about <strong>5 minutes</strong>. The team gets the same
    ...
    <p>
      ...
      eating hours your team should be spending on real conversations, that's the gap this closes.
    </p>
  </CaseStudyLayout>
);
